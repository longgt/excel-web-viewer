...
export const SpreadsheetGrid: React.FC<SpreadsheetGridProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-white overflow-hidden relative">
      {/* Table viewport with native horizontal/vertical scroll */}
      <div className="flex-1 overflow-auto bg-slate-100/50 relative select-text">
        <table className="w-full border-separate border-spacing-0 text-xs font-sans">
          ...
          <tbody className="bg-white divide-y divide-slate-200">
            {filteredItems.length === 0 ? (
              ...
              filteredItems.map((item, displayRowIndex) => {
